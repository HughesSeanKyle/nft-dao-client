...
export default function Home() {
	...
	/*
    This function can be called getProviderOrSigner(true). If true, this gives wallet provider to sign trxs on your behalf.
    
    This function also checks who is interacting with the contract via address. 
    It is to ensure that your wallet provider produces the 'credentials' to interact with the contract. Can see it as a form of auth as well. 
  */
